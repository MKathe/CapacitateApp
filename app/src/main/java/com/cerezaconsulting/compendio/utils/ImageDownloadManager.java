...
public class ImageDownloadManager {
    ...
    public static boolean saveBitmapImage(Bitmap bitmap, String path, String url) {
        ...
        try {
            ...
            String imageName = url.substring(54, url.indexOf(".jpg"))+".jpg";
            String fileName = getHashCodeBasedFileName(url);
            String imagePath = path + FORWARD_SLASH + imageName;
            FileOutputStream fileOutputStream = new FileOutputStream(imagePath);
            bitmap.compress(getCompressFormatFromFileName(imageName), 100, fileOutputStream);
