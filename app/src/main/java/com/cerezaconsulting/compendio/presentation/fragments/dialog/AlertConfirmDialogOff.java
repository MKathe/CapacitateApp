 ...
 */
public class AlertConfirmDialogOff extends AlertDialog implements Validator.ValidationListener {
    ...
    private ChapterContract.View viewContract;
    private ImageView actionCloseDialog;
    private Validator validator;
    private String idTraining;

    public AlertConfirmDialogOff(Context context, final ChapterContract.View viewContract, String button1, String textConfirmDialog) {
        super(context);
